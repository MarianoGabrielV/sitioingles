  ...
  <div class="page" id="top">
    <header class="hero">
      <nav class="nav container">
        <a class="brand" href="#top" aria-label="TKE Instituto Virtual de Ingles">
          <svg
            class="brand-logo"
            viewBox="0 0 120 120"
            aria-hidden="true"
          ...
          >
            <circle cx="60" cy="60" r="57" fill="none" stroke="#ffffff" stroke-width="4" />
            <circle cx="60" cy="60" r="52" fill="none" stroke="#d4dde2" stroke-width="1.5" />
            <path
            ...
            <path
              ...
              stroke-linecap="round"
            />
            <text x="67" y="59" text-anchor="middle" fill="#1b6b75" font-weight="800" font-size="18">
              TKE
            </text>
            <text x="60" y="89" text-anchor="middle" fill="#111827" font-weight="800" font-size="16">
              INGLES
            </text>
          </svg>
          <span class="brand-text">TKE Instituto Virtual de Ingles</span>
        </a>
        <a class="nav-cta" href="#contacto">Solicitar Informacion</a>
      </nav>

      <div class="hero-content container">
        <p class="badge">Inscripciones Abiertas</p>
        ...
        <div class="hero-actions">
          <a class="btn btn-primary" href="#propuesta">Ver Propuesta</a>
          <a class="btn btn-secondary" href="#contacto">Contactar Ahora</a>
        </div>
      </div>
    ...
    <main>
      <section class="section container" id="propuesta">
        ...
        <div class="cards">
          <article class="card" v-for="item in benefits" :key="item.title">
            <h3>{{ item.title }}</h3>
            <p>{{ item.text }}</p>
          </article>
        </div>
      ...
      <section id="instituto" class="section section-accent">
        <div class="container">
          ...
          <div class="pricing">
            <article class="price-card" v-for="item in highlights" :key="item">
              <p>{{ item }}</p>
            </article>
          </div>
        </div>
